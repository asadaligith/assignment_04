...
#Here's a sample run of the program (user input is in bold italics - note 
#the space between the prompt and the user input!):
...
def main():
    try:
        ...
        print(f"My favorit animal is also {user_input} ")
    except ValueError:
        print("Invalid Input! Give right input")
